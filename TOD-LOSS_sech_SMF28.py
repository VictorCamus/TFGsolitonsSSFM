...
D = 18 # Factor de dispersió (ps/nm/km)
Alfa_dB = 0.17 # Pèrdues de la fibra (dB/km)
n = 1.462 # Índex de refracció de la fibra
tau_0 = 100 # FWHM del pols (ps)
lo = 1550 # Longitud d'ona (nm)
n2 = 2.96e-02 # Índex de refracció de l'efecte Kerr (nm²/W)
Radi = 4100 # Radi de la fibra (nm)
Ordre = 2
...
plt.xlabel(r'$t$ (ps)')
plt.ylabel(r'|$A$|$^{2}$ (mW)')
plt.title(r'Simulació Fibra SMF-28 ULL')
